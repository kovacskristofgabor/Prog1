...
try {
    ...
    Image cpp1 {Point{0,300}, "badge.jpg"};
    Image cpp2 {Point{300,600}, "badge.jpg"};
    Image cpp3 {Point{500,100}, "badge.jpg"};
...
/* Compile command
g++ -w -Wall -std=c++11 Graph.cpp Window.cpp GUI.cpp Simple_window.cpp drill13.cpp `fltk-config --ldflags --use-images` -o drill13
*/
